...
def play_game():
    ...
    choice = user_input()
    if choice == "1":
        house(adventure_extension.creature,adventure_extension.item,adventure_extension.super_weapon,adventure_extension.is_super,adventure_extension.lives)
    elif choice == "2":
        cave(adventure_extension.item,adventure_extension.super_weapon,adventure_extension.is_super)
    else:
